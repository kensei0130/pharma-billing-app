            ...
            <nav className="bg-slate-900 border-b border-indigo-500/10 sticky top-0 z-50 text-white shadow-lg shadow-slate-900/5">
                <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center gap-4 min-[1200px]:gap-8">
                            {/* Logo Area */}
                        ...
                        {/* Right Actions */}
                        <div className="flex items-center gap-3 min-[1200px]:gap-6">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline">通常画面へ</span>
                            ...
                            <div className="flex items-center gap-2 min-[1200px]:gap-4">
                                <div className="hidden min-[1200px]:flex flex-col items-end">
